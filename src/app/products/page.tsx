...
import { ChevronDown, Home, Wifi, Lightbulb, Shield, Thermometer, Zap, CheckCircle2, Award, Menu, X, Phone, MapPin, Mail, Facebook, Instagram, BadgeCheck } from 'lucide-react'
...
export default function ProductsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-slate-950/98 backdrop-blur-md border-t border-blue-500/20">
            <div className="max-w-7xl mx-auto px-4 py-4 space-y-1">
              ...
              <Link href="/pricing" className="block px-4 py-3 text-slate-700 hover:text-blue-600 hover:bg-slate-800/30 rounded-lg transition-colors" onClick={() => setIsMobileMenuOpen(false)}>Pricing</Link>
              <Link href="/products" className="block px-4 py-3 text-blue-400 font-medium bg-slate-800/50 rounded-lg" onClick={() => setIsMobileMenuOpen(false)}>Products</Link>
      ...
      {/* Footer */}
      <footer className="border-t border-blue-500/20 bg-slate-950/50 py-16 px-6 mt-12">
        <div className="max-w-7xl mx-auto">
