        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative bg-slate-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-3xl p-8">
                <Lightbulb className="w-24 h-24 text-cyan-400 mx-auto mb-6" />
                <h3 className="text-2xl font-bold text-white text-center mb-4">Intelligent Illumination</h3>
                <p className="text-slate-400 text-center">
                  Transform your space with dynamic lighting that responds to your needs
                </p>
              </div>
            </div>
          </div>
